...
class AdminExams extends Component {
    constructor(props) {
        ...
        this.generateExams = this.generateExams.bind(this);
    ...
    getExams() {
        dataService.getAllExams().then(exams => {
            let sorted = exams.exams.sort();
            sorted.reverse();
            this.setState({
                exams: sorted
            })
    ...
    generateExams() {
        ...
        dataService.generateExam(Number(size), subject, name).then(exam => {
            // console.log(exam);
            this.getExams();
        })
    }
    ...
    render() {
        const { exams, subject } = this.state;
        const {
            classes
        } = this.props;
                ...
                <div className={classes.header}>
                    <div className={classes.headerWrapper}>
                        ...
                        <div className={classes.form}>
                            ...
                            <Button color="inherit" onClick={this.generateExams}>
                                Създаване
                            </Button>
                        </div>
                    </div>
